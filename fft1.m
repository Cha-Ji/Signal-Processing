...
f0= fft(y0); f1= fft(y1); f2= fft(y2);

subplot(4,2,1); plot(t2, y2); grid
subplot(4,2,3); stem(t0, y0); grid; subplot(4,2,4); stem(abs(f0)); grid 
subplot(4,2,5); stem(t1, y1); grid; subplot(4,2,6); stem(abs(f1)); grid 
subplot(4,2,7); stem(t2, y2); grid; subplot(4,2,8); stem(abs(f2)); grid
